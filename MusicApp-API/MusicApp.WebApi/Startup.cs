...
namespace MusicApp.WebApi
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.Map("/api/songs/songlog", HandleUserReferanceRoute);
            app.Map("/api/songs/isliked", HandleUserReferanceRoute);
            app.Map("/api/accounts/user", HandleUserReferanceRoute);
            app.Map("/api/artists/likes", HandleUserReferanceRoute);
            app.Map("/api/artists/isliked", HandleUserReferanceRoute);
